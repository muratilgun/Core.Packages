...
public class JwtHelper : ITokenHelper
{
    ...
    public JwtHelper(DateTime accessTokenExpiration, IConfiguration configuration)
    {
        ...
        _tokenOptions = Configuration.GetSection(configurationSection).Get<TokenOptions>()
            ?? throw new NullReferenceException($"\"{configurationSection}\" section cannot found in appsettings.json");
